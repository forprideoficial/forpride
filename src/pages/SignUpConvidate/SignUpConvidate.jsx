...
function SignUpConvidate() {

  const {email, patron} = useParams();
...
function handleSelectMinAge(e) {
  ...
  return (
    <div className="content-SignUpConvidate">
      <div className="bloco">
      ...
      <div className="slide-SignUpConvidate">
      <div className="images-SignUpConvidate" key={image1}>
            <img src={image1} alt="" />
        </div>
      </div>
    </div>
